...
<div class="container">
	...
	<!-- container -->
		...
		Welcome User...!!</font></h2>";
                                echo"<h3>
Here your latest Notifications are Available</h3>";
		}
		?>
  ...
  <div class="panel-heading"><font color=blue>For Latest news</font></div>
...
<!-- footer-->
			...
			<nav class="navbar navbar-default navbar-bottom" style="background:red">
  <div class="container">
  
  <ul class="nav navbar-nav navbar-right">
    <li> Developed by  Ushasree Mathi</li>
      </ul>
